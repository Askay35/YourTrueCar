                        ...
                        <div class="result-auto__bottom">
                            <div class="result-auto__types">
                                <div class="form-group">
                                    ...
                                    <div class="dropdown">
                                        <button class="dropdown__button" type="button">Основні пошкодження</button>
                                        <ul class="dropdown__list">
                                            <li class="dropdown__list-item" data-value="travel">Основні пошкодження</li>
                                            <li class="dropdown__list-item" data-value="lessons">Porshe</li>
                                            <li class="dropdown__list-item" data-value="photo">Ferrari</li>
                                            <li class="dropdown__list-item" data-value="sport">Ford</li>
                                        </ul>
                                    ...
                                    <div class="dropdown">
                                        <button class="dropdown__button" type="button">Вторинні ушкодження</button>
                                        <ul class="dropdown__list">
                                            <li class="dropdown__list-item" data-value="travel">Вторинні ушкодження</li>
                                            <li class="dropdown__list-item" data-value="lessons">Porshe</li>
                                            <li class="dropdown__list-item" data-value="photo">Ferrari</li>
                                            <li class="dropdown__list-item" data-value="sport">Ford</li>
                                        </ul>
